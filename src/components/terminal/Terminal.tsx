...
export function Terminal() {
  ...
  if (mode === "boot") {
    return (
      <div
        data-theme={theme}
        className={cn("h-screen w-screen overflow-hidden", scanlines && "crt-scanlines crt-flicker")}
      >
        <BootSequence />
      </div>
    );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex-1 min-h-0 overflow-y-auto term-scroll px-3 sm:px-5 pt-3 sm:pt-5 pb-2"
      >
      ...
      <div className="shrink-0 border-t border-term-dim bg-term-bg/95 backdrop-blur-sm">
        ...
        <div className="px-3 sm:px-5 py-1 border-t border-term-dim flex items-center justify-between text-[10px] sm:text-xs text-term-muted select-none">
          <div className="flex items-center gap-3 min-w-0 truncate">
            <span>
              theme: <span className="text-term-cyan">{themeName}</span>
            </span>
            <span>
              scanlines:{" "}
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <span>
              <span className="text-term-yellow">Ctrl+C</span> cancel
            </span>
          </div>
        </div>
      </div>
